describe("SOL_SCRIPTS.JS", function() {
    ...
    let martianUrl = div3.querySelector(".martian_url");
    let marsImg = div3.querySelector(".mars");
    let photoDescription = div3.querySelector(".photo_description");
    let id01 = div3.querySelector("#id01");
    ...
    it("declares and initializes the following variables: 'currentIndex' (0); 'slideNumber' (1); 'currentInterval' (0); 'alreadyRunning' (false); 'loading' (refers to the 'loading' <div>); 'loadingInfo' (refers to the innerHTML of the first child element of the 'loading' <div>); 'online' (refers to the browser's online status); visitedLinkStringKey (equal to the concatenation of 'visitedLinkString' + the current sol); and 'visitedLinkString' (equal to the 'visitedLinkStringKey' localStorage variable if present, OR an empty String if not)", function() {
        ...
        expect(visitedLinkString).toBeString();
    });
    ...
    describe("the 'responsiveImage()' function", function() {
        ...
        it("sets the 'marsSlides' variable to refer to a NodeList Object that holds references to all 'div3' elements with a className of 'mars'", function() {
        ...
        it("sets the 'marsURLs' variable to refer to a NodeList Object that holds references to all 'div3' elements with a className of 'martian_url'", function() {
        ...
        it("updates the 'div3' <h1> element with the id attribute of 'martianHeading' to display an appropriately-informative heading to the User, detailing the Rover name, martian sol, and earth date", function() {
            expect(div3.querySelector("#martianHeading").innerHTML).toEqual("<em>Spirit</em> <strong>Martian Sol 1</strong> <em>[Earth Date 2004-01-05]</em>");
        });
        ...
        it("sets the text <input> element's placeholder text to 'placeholderText'", function() {
            expect(div3.querySelector("#slideSelect").nextElementSibling.placeholder).toMatch(placeholderText);
        });
    });
    describe("the 'fullScreenImage()' function", function() {
        it("is triggered when the User clicks the 'Fullscreen Image' <button>", function() {
            ...
            let fullscreenBtn = div3.querySelector("#fullscreenBtn");
        ...
        it("scrolls the 'div3' 'imageCell' <td> element into view, facilitating the display of martian images in fullscreen mode", function() {
            let encompassingDiv = document.querySelectorAll(".encompassing")[1];
            encompassingDiv.style.display = "block";
            fullscreenImage();
            let imageCell = div3.querySelector("#imageCell");
    ...
    describe("the 'departFullscreen()' function", function() {
        it("is triggered when the martian image is clicked in order to exit (depart) the bespoke fullscreen mode", function() {
            let martianImage = div3.querySelector(".mars");
    ...
    describe("the 'landscapeOrPortrait()' function", function() {
        ...
        it("sets the width property of the 'marsTable' to 100%", function() {
            expect(div3.querySelector(".marsTable").style.width).toMatch("100%");
        });
    });
    describe("the 'manualNext()' function", function() {
        it("is triggered when the User clicks the 'NEXT' <button>", function() {
            ...
            let nextBtn = div3.querySelector(".nextBtn");
        ...
        it("clears the text <input> field", function() {
            let textInput = div3.querySelector("#slideSelect").nextElementSibling;
            textInput.value = "1";
    ...
    describe("the 'manualPrevious()' function", function() {
        it("is triggered when the User clicks the 'PREVIOUS' <button>", function() {
            let previousBtn = div3.querySelector(".previousBtn");
        ...
        describe("checks that the numerical representation of 'slideNumber' is greater than 0 and less than the length of the slideshowObject.photos array, and executes the following operations if the check evaluates to TRUE:", function() {
            describe("if there is already a martian slideshow running, it:", function() {
                ...
                it("updates the 'timingInfo' <p> element, clarifying that the timing interval has been reset to '0'", function() {
                    let timingInfo = div3.querySelector("#timingInfo");
                ...
                it("sets the value of the 'interval-select' <select> element to 0", function() {
                    let intervalSelect = div3.querySelector("#interval-select");
    ...
    describe("the 'setupSlideshow(interval, index, alreadyRunnning)' function", function() {
        it("is triggered when the User <select>s a slideshow timing interval, in response to the \"change\" event", function() {
            div3.querySelector("#interval-select").addEventListener('change', function() { setupSlideshow(currentInterval, currentIndex, alreadyRunning); });
            let setupSlideshowSpy = spyOn(window, 'setupSlideshow');
            expect(setupSlideshowSpy).not.toHaveBeenCalled();
            div3.querySelector("#interval-select").dispatchEvent(changeEvent);
    ...
    describe("the 'solSelectScreen()' function", function() {
        ...
        it("is triggered when the User clicks the '* Return to Sol Selection *' <button>", function() {
            ...
            let solSelectButton = div3.querySelector(".solSelection");
    ...
    describe("the 'increaseWidth()' function", function() {
        let increaseWidthButton = div3.querySelectorAll(".increase")[0];
    ...
    describe("the 'decreaseWidth()' function", function() {
        let decreaseWidthButton = div3.querySelectorAll(".decrease")[0];
    ...
    describe("the 'increaseHeight()' function", function() {
        let increaseHeightButton = div3.querySelectorAll(".increase")[1];
    ...
    describe("the 'decreaseHeight()' function", function() {
        let decreaseHeightButton = div3.querySelectorAll(".decrease")[1];
    ...
    describe("the 'increaseBlur()' function", function() {
        let increaseBlurButton = div3.querySelectorAll(".increase")[2];
    ...
    describe("the 'decreaseBlur()' function", function() {
        let decreaseBlurButton = div3.querySelectorAll(".decrease")[2];
    ...
    describe("the 'increaseBrightness()' function", function() {
        let increaseBrightnessButton = div3.querySelectorAll(".increase")[3];
    ...
    describe("the 'decreaseBrightness()' function", function() {
        let decreaseBrightnessButton = div3.querySelectorAll(".decrease")[3];
        ...
        describe("checks whether the 'brightnessValue' page variable is greater than 0, and executes the following operations if the check evaluates to TRUE:", function() {
    ...
    describe("the 'increaseContrast()' function", function() {
        let increaseContrastButton = div3.querySelectorAll(".increase")[4];
    ...
    describe("the 'decreaseContrast()' function", function() {
        let decreaseContrastButton = div3.querySelectorAll(".decrease")[4];
        it("is invoked when the User clicks the '-' <button> that is situated beneath the 'Contrast +/-' <label>", function() {
    ...
    describe("the 'increaseInvert()' function", function() {
        let increaseInvertButton = div3.querySelectorAll(".increase")[5];
    ...
    describe("the 'decreaseInvert()' function", function() {
        let decreaseInvertButton = div3.querySelectorAll(".decrease")[5];
    ...
    describe("the 'increaseOpacity()' function", function() {
        let increaseOpacityButton = div3.querySelectorAll(".increase")[6];
    ...
    describe("the 'decreaseOpacity()' function", function() {
        let decreaseOpacityButton = div3.querySelectorAll(".decrease")[6];
    ...
    describe("the 'increaseSepia()' function", function() {
        let increaseSepiaButton = div3.querySelectorAll(".increase")[7];
    ...
    describe("the 'decreaseSepia()' function", function() {
        let decreaseSepiaButton = div3.querySelectorAll(".decrease")[7];
    ...
    describe("the 'toggleEditingDiv()' function", function() {
        let controlsHeading = div3.querySelector(".controlsHeading");
        let editingDiv = div3.querySelector("#editingDiv");
    ...
    describe("the 'toggleWidthDiv()' function", function() {
        let widthLabel = div3.querySelectorAll("LABEL")[0];
        let widthDiv = div3.querySelector("#widthDiv");
    ...
    describe("the 'toggleHeightDiv()' function", function() {
        let heightLabel = div3.querySelectorAll("LABEL")[1];
        let heightDiv = div3.querySelector("#heightDiv");
    ...
    describe("the 'toggleBlurDiv()' function", function() {
        let blurLabel = div3.querySelectorAll("LABEL")[2];
        let blurDiv = div3.querySelector("#blurDiv");
    ...
    describe("the 'toggleBrightnessDiv()' function", function() {
        let brightnessLabel = div3.querySelectorAll("LABEL")[3];
        let brightnessDiv = div3.querySelector("#brightnessDiv");
    ...
    describe("the 'toggleContrastDiv()' function", function() {
        let contrastLabel = div3.querySelectorAll("LABEL")[4];
    ...
    describe("the 'toggleInvertDiv()' function", function() {
        let invertLabel = div3.querySelectorAll("LABEL")[5];
        let invertDiv = div3.querySelector("#invertDiv");
    ...
    describe("the 'toggleOpacityDiv()' function", function() {
        let opacityLabel = div3.querySelectorAll("LABEL")[6];
        let opacityDiv = div3.querySelector("#opacityDiv");
    ...
    describe("the 'toggleSepiaDiv()' function", function(){
        let sepiaLabel = div3.querySelectorAll("LABEL")[7];
        let sepiaDiv = div3.querySelector("#sepiaDiv");
    ...
    describe("the 'toggleAudioControls()' function", function() {
        let musicHeading = div3.querySelector(".musicHeading");
    ...
    describe("the 'createLink()' function", function() {
        let martianURLDiv = div3.querySelector(".martian_url");
